...
export function HeroTitle() {
  ...
  return (
    <h1 className="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-foreground leading-[1.3] font-pixel min-h-[80px] sm:min-h-[120px] lg:min-h-[160px]">
