...
interface CommandPaletteProps {
  ...
  isOpen: boolean;
  /** Callback function invoked to close the command palette */
  onClose: () => void;
  /** Optional callback to open the CV resume modal */
  onOpenCV?: () => void;
  /** Optional callback to toggle the visibility of the palette */
  onToggleOpen?: () => void;
}

/**
 * CommandPalette Component (`Cmd+K` / `Ctrl+K`)
 *
 * Provides a keyboard-accessible search and command launcher overlay for fast site navigation,
 * theme toggling, CV viewing, and external social profile access.
 */
export function CommandPalette({ isOpen, onClose, onOpenCV, onToggleOpen }: CommandPaletteProps) {
