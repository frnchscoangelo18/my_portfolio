...
const Linkedin = ({ className }: { className?: string }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#0A66C2">
...
const Instagram = ({ className }: { className?: string }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <linearGradient id="ig-grad" x1="2.75" y1="2.75" x2="21.25" y2="21.25">
...
const EmailIcon = ({ className }: { className?: string }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#EA4335">
...
export function Contact() {
  const socialLinks = [
    ...
    { name: "Instagram", icon: <Instagram className="h-5 w-5" />, href: "https://www.instagram.com/gelskrrttt", handle: "gelskrrttt" },
  ];
          ...
          <div className="mt-12 flex flex-col items-center justify-center gap-10">
            ...
            <div className="flex flex-wrap justify-center gap-3 md:gap-4 w-full max-w-full">
              {socialLinks.map((social) => (
                ...
                >
                  <div className="flex-shrink-0 scale-90 md:scale-100">{social.icon}</div>
