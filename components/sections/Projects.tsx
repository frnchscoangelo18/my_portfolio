...
const CATEGORIES = ["All", "Full-Stack", "AI", "Frontend"] as const;
    ...
    <section id="projects" className="py-10 md:py-20">
      <div className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <FadeIn direction="up">
          <div className="flex flex-col items-center justify-center text-center mb-10">
            ...
            <p className="mt-4 sm:mt-6 max-w-2xl text-base sm:text-lg text-muted-foreground leading-relaxed">
              A selection of projects I&apos;ve built or am currently working on. Click any card to inspect full technical architecture and key features.
            </p>
          </div>
        </FadeIn>
        ...
        <FadeIn direction="up" delay={0.1}>
          <div className="flex items-center justify-center flex-wrap gap-2 mb-10" role="tablist" aria-label="Project Categories">
            {CATEGORIES.map((cat) => {
              ...
              >
                <SpotlightCard className="h-full flex flex-col group cursor-pointer" onClick={() => setActiveProjectModal(project)}>
                  ...
                  <div className="w-full h-52 bg-gradient-to-br from-white/10 to-transparent dark:from-white/5 dark:to-transparent border-b border-border/30 flex items-center justify-center relative overflow-hidden backdrop-blur-md">
                    ...
                    <div className="absolute top-3 left-3 z-20 bg-background/80 backdrop-blur-md text-foreground text-xs font-semibold px-3 py-1 rounded-full border border-border/50">
                      {project.category}
                    </div>
